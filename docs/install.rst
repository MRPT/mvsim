...
- CMake >= 3.9
- MRPT (>=2.5.6): In Windows, `build from sources <https://docs.mrpt.org/reference/stable/compiling.html>`_
  or `get the precompiled installer <https://docs.mrpt.org/reference/stable/download-mrpt.html>`_.
