	...
	const FrictionBase::TFrictionInput& input) const
{
	...
	const mrpt::math::TPoint3D_<double> linAccGlobal = myVehicle_.getLinearAcceleration();
	const mrpt::poses::CPose2D vehiclePose = myVehicle_.getPose();
	mrpt::math::TPoint3D_<double> linAccLocal;
