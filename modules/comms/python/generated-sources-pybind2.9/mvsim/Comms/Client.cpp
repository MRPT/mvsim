...
void bind_mvsim_Comms_Client(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // mvsim::Client file:mvsim/Comms/Client.h line:48
		...
		{ // mvsim::Client::InfoPerTopic file:mvsim/Comms/Client.h line:119
			...
			cl.def("assign", (struct mvsim::Client::InfoPerTopic & (mvsim::Client::InfoPerTopic::*)(const struct mvsim::Client::InfoPerTopic &)) &mvsim::Client::InfoPerTopic::operator=, "C++: mvsim::Client::InfoPerTopic::operator=(const struct mvsim::Client::InfoPerTopic &) --> struct mvsim::Client::InfoPerTopic &", pybind11::return_value_policy::automatic, pybind11::arg(""));
		}
