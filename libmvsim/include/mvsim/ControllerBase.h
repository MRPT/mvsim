...
namespace mvsim
{
    ...
    virtual void teleop_interface(const TeleopInput &in, TeleopOutput &out) override
    {
      ...
      out.append_gui_lines += std::string("Toggle logging [L]. Clear logs[C]. New log session [N]. Now ")
    ...
    virtual void setLogRecording(bool recording) { m_veh.setRecording(recording); }
