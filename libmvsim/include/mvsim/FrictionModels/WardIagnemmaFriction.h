...
namespace mvsim
{
	/** Friction model implemented with respect to http://web.mit.edu/mobility/publications/Iagnemma_TRO_07.pdf
    ...
    double m_A_roll, m_R1, m_R2; //!< Ward-Iagnemma rolling resistance coefficient
	};
}
