...
WardIagnemmaFriction::WardIagnemmaFriction(VehicleBase & my_vehicle, const rapidxml::xml_node<char> *node) :
...
void WardIagnemmaFriction::evaluate_friction(const FrictionBase::TFrictionInput &input, mrpt::math::TPoint2D &out_result_force_local) const
{
