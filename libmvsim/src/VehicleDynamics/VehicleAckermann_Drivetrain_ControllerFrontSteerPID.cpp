...
void DynamicsAckermannDrivetrain::ControllerFrontSteerPID::load_config(const rapidxml::xml_node<char>&node )
{
...
void DynamicsAckermannDrivetrain::ControllerFrontSteerPID::teleop_interface(const TeleopInput &in, TeleopOutput &out)
{
